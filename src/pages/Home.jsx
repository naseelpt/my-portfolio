    ...
    <div className='w-full h-fit'>
      ...
      <div className='grid grid-cols-1'>
        <div className='pt-10'>
          ...
          <p className='md:px-96 text-white pt-10'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quisquam quos sapiente porro quod possimus quidem placeat et eaque ut iure nesciunt quibusdam non tempoLorem, ipsum dolor sit amet consectetur adipisicing elit. Quisquam quos sapiente porro quod possimus quidem placeat et eaque ut iure nesciunt quibusdam non temp</p>
        </div>
      </div>
    </div>
